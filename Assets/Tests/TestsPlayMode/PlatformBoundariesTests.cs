...
namespace Tests.TestsPlayMode
{
    public class PlatformBoundariesTests
    {
        ...
        public IEnumerator BoundariesAreCreated()
        {
            ...
            PlatformBoundariesGenerator platformBoundariesGenerator = new GameObject().AddComponent<PlatformBoundariesGenerator>();
            ...
            _getAccessToPrivate.SetPrivateFieldValue(typeof(PlatformBoundariesGenerator), platformBoundariesGenerator,
                "spacing", 1f);  
            _getAccessToPrivate.SetPrivateFieldValue(typeof(PlatformBoundariesGenerator), platformBoundariesGenerator,
                "platformRadius", 5f);  _getAccessToPrivate.SetPrivateFieldValue(typeof(PlatformBoundariesGenerator), platformBoundariesGenerator,
            ...
            float platformRadius = (float)_getAccessToPrivate.GetPrivateFieldValue(typeof(PlatformBoundariesGenerator), platformBoundariesGenerator, "platformRadius");
            float spacing = (float)_getAccessToPrivate.GetPrivateFieldValue(typeof(PlatformBoundariesGenerator), platformBoundariesGenerator, "spacing");
